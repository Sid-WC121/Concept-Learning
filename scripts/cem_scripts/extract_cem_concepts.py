...
def generate_data_loaders_cub(suffix):
    ...
    cub_location = DATASET_ROOT / "CUB{}".format(suffix)
    train_data_path = str(cub_location / "preprocessed" / "train.pkl")
    valid_data_path = str(cub_location / "preprocessed" / "val.pkl")
    test_data_path = str(cub_location / "preprocessed" / "test.pkl")
    ...
    train_dl = load_data(
        ...
        n_class_attr=2,
        image_dir=str(cub_location / "images"),
        resampling=False,
...
def generate_data_loaders_mnist(suffix):
    ...
    mnist_location = DATASET_ROOT / "colored_mnist{}".format(suffix)
    train_data_path = str(mnist_location / "preprocessed" / "train.pkl")
    valid_data_path = str(mnist_location / "preprocessed" / "val.pkl")
    test_data_path = str(mnist_location / "preprocessed" / "test.pkl")
    ...
    train_dl = load_data(
        ...
        uncertain_label=False,
        n_class_attr=2,
        image_dir=str(mnist_location / "images"),
        resampling=False,
        root_dir=str(DATASET_ROOT),
        num_workers=num_workers,
        path_transform=None
